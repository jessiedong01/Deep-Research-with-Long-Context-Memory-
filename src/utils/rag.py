...
from utils.dataclass import RagRequest, RagResponse
...
from utils.utils import construct_sources_string, reset_citation_indices
...
class RagAgent(dspy.Module):
    ...
    async def aforward(self, rag_request: RagRequest | str) -> RagResponse:
